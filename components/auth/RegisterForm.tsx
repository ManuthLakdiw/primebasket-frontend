    ...
    return (
        <motion.div
            ...
            <div className="space-y-3">
                ...
                <button
                    type="button"
                    className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#4285F4] hover:bg-[#357ae8] transition-colors"
                >
